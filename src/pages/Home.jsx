...
const Home = () => {
  return (
    <>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-8 py-24 bg-gradient-to-r from-[#ffffff8f] to-orange-50 mt-6 min-h-[80vh] relative">
        <CanvasBackground />
